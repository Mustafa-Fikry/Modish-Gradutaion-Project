...
const MEN_CATEGORY_ID = "69faa0de4733f01c24652a4d";

const ComfortableDesign = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(`${BASE_URL}?categories=${MEN_CATEGORY_ID}`)
            .then((res) => {
    ...
    return (
        ...
        <div className='min-h-screen bg-[#f5f0eb]'>
            ...
            {/* Header */}
            <section className='px-14 py-14 bg-[#F2F2F7] dark:bg-[#121212]'>
                <div className='container mx-auto'>
                    <h1 data-aos="fade-down" className="text-5xl font-bold text-[#524B6B]"> Daily Standard of Pure Comfort </h1>
                    <p data-aos="fade-up" data-aos-delay="100" className="text-[#8E8684] mt-3 text-lg"> Modish brings you a curated selection of breathable essentials </p>
                </div>
            </section>
            {/* Product Info */}
            <section className='py-14 px-4 md:px-14 bg-white dark:bg-[#121212] rounded-t-[50px] dark:rounded-none'>
                <div className='container mx-auto'>
                    {!loading && !error && (
                        <p className="text-[#AEA9A7] mb-8 font-bold text-sm uppercase tracking-widest">
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8'>
                            ...
                            {products.map((product, index) => (
                                ...
                                >
                                    ...
                                    <div className="relative h-64 w-full overflow-hidden rounded-[22px] bg-[#F9F9F9]">
...
export default ComfortableDesign;