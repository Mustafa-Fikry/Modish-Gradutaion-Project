...
const AllProducts = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F2F2F7] dark:bg-[#121212]">
            ...
            {/* Header */}
            <section className="bg-[#F2F2F7] dark:bg-[#121212] py-14 px-4 md:px-14">
                <div className="container mx-auto">
                    <h1 data-aos="fade-down" className="text-5xl font-bold text-[#524B6B]">
                        Modish Collection
                    </h1>
            ...
            <section className="py-14 px-4 md:px-14 bg-white dark:bg-[#121212] rounded-t-[50px]">
                <div className="container mx-auto">
                    ...
                    {loading && (
                        <div className="text-center py-20 text-xl font-semibold text-[#524B6B] dark:bg-[#121212] ">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                            {products.map((product, index) => (
                                <div
                                    ...
                                    className="bg-white dark:bg-[#18181C] dark:border-slate-800 rounded-[30px] p-4 flex flex-col gap-3 shadow-sm hover:shadow-xl transition-all duration-300 group border border-transparent hover:border-[#F2F2F7]"
                                >
                                    ...
                                    <button
                                        ...
                                        className={`py-2.5 mt-2 rounded-full font-bold text-sm text-white transition-all duration-300 active:scale-95 ${
                                            addedId === product._id
